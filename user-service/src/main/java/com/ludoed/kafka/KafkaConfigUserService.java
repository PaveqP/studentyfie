...
public class KafkaConfigUserService {
    ...
    @Bean
    public KafkaTemplate<String, AgentFullDto> agentKafkaTemplate() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UniversityInfo> universityKafkaListenerFactory() {
